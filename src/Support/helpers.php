...
if (! function_exists('fahipay_redirect')) {
    function fahipay_redirect(string $transactionId, float $amount, ?string $description = null): RedirectResponse
    {
...
if (! function_exists('fahipay_config')) {
    function fahipay_config(?string $key = null, mixed $default = null): mixed
    {
